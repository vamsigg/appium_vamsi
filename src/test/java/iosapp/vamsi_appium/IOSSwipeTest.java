...
public class IOSSwipeTest extends IOSBaseTest{
	...
	{
	   //Bundle ID is there for it own app we can see in official site of apple
	     ...
	     {
	         System.out.println(driver.findElement(By.xpath("//XCUIElementTypeNavigationBar")).getAttribute("name")); //for outher tags, there are multiple same name tags are there
	         Map<String,Object> params1 = new HashMap<String,Object>();
	         params1.put("direction","left");
	       //params1.put("element",((RemoteWebElement)ele).getId());  
	       //In ios it swipe in center therefore no need mention element separately in this case 
	         driver.executeScript("mobile:swipe", params1);
	     }
	     driver.navigate().back();
	   
	     driver.findElement(AppiumBy.accessibilityId("Albums")).click();  //for starting again freshly, when we come back again
	}
}
